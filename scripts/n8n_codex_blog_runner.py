...
def run_blog_job(
    ...
    # Pin writing quality regardless of stale runner/launchd environment variables.
    env["CODEX_MODEL"] = os.environ.get("BLOG_WRITER_MODEL", "gpt-5.6-sol")
    env["CODEX_REASONING_EFFORT"] = os.environ.get("BLOG_WRITER_REASONING_EFFORT", "xhigh")
    env["DAILY_POST_LIMIT"] = os.environ.get("BLOG_WRITER_DAILY_POST_LIMIT", "2")
